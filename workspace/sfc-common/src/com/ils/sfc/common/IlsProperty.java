...
public class IlsProperty<T> extends BasicProperty<T> implements java.io.Serializable {
    ...
    public static final IlsProperty<String> COLLECT_DATA_CONFIG = new IlsProperty<String>(IlsSfcNames.COLLECT_DATA_CONFIG, String.class, EMPTY_COLLECT_DATA_CONFIG, true);
    public static final IlsProperty<String> CONFIRM_CONTROLLERS_CONFIG = new IlsProperty<String>(IlsSfcNames.CONFIRM_CONTROLLERS_CONFIG, String.class, EMPTY_CONFIRM_CONTROLLERS_CONFIG, true);
    ...
    public static final IlsProperty<String> MONITOR_DOWNLOADS_CONFIG = new IlsProperty<String>(IlsSfcNames.MONITOR_DOWNLOADS_CONFIG, String.class, EMPTY_MONITOR_DOWNLOAD_CONFIG, true);
    public static final IlsProperty<String> MONITOR_DOWNLOADS_POSTING_METHOD = new IlsProperty<String>(IlsSfcNames.POSTING_METHOD, String.class, "ils.sfc.client.windows.monitorDownload.defaultPostingMethod");
    public static final IlsProperty<String> MONITOR_DOWNLOADS_WINDOW = new IlsProperty<String>(IlsSfcNames.WINDOW, String.class,  "SFC/MonitorDownload", false);
    ...
    public static final IlsProperty<String> PV_MONITOR_CONFIG = new IlsProperty<String>(IlsSfcNames.PV_MONITOR_CONFIG, String.class, EMPTY_PV_MONITOR_CONFIG, true);
    ...
    public static final IlsProperty<String> WRITE_OUTPUT_CONFIG = new IlsProperty<String>(IlsSfcNames.WRITE_OUTPUT_CONFIG, String.class, EMPTY_WRITE_OUTPUT_CONFIG, true);
