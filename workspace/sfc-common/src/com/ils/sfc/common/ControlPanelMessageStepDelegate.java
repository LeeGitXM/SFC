...
public class ControlPanelMessageStepDelegate extends AbstractIlsStepDelegate implements
ControlPanelMessageStepProperties {

	protected ControlPanelMessageStepDelegate() {
		super(properties);
	}
