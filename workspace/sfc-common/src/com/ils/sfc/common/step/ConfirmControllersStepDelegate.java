...
public class ConfirmControllersStepDelegate extends AbstractIlsStepDelegate implements
ConfirmControllersStepProperties {

	protected ConfirmControllersStepDelegate() {
		super(properties);
	}
