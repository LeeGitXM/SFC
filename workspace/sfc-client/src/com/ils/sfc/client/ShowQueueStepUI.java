...
public class ShowQueueStepUI extends AbstractStepUI {
    ...
    public static final class ShowQueueStepFactory extends AbstractMessageQueueStepDelegate implements ClientStepFactory {

    	ShowQueueStepUI UI = new ShowQueueStepUI();
