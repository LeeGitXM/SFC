...
public interface IlsSfcTestProperties   {
	public final static String MODULE_ID = "ilssfctest";            // See module-ils-sfc-test.xml
	public final static String MODULE_NAME = "ILS-SFC-TEST";        // See build-ils-scf-test.xml
