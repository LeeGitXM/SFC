...
insert into SfcClassMap values ('S88-LIBRARY-CALLER','enclosing-step','enclosure',0);
insert into SfcClassMap values ('S88-LIBRARY-TASK','enclosing-step','enclosure',0);
