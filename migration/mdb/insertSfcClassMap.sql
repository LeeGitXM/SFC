...
insert into SfcClassMap values ('S88-ABORT-BLOCK', 'com.ils.abortStep','');
...
insert into SfcClassMap values ('S88-MANUAL-DATA-ENTRY-TASK','com.ils.dataEntryStep','');
...
insert into SfcClassMap values ('S88-MESSAGE_QUEUE-TASK','com.ils.queueMessageStep','');
...
insert into SfcClassMap values ('S88-STOP-BLOCK','com.ils.abortStep','');
insert into SfcClassMap values ('S88-STOP-TASK','com.ils.abortStep','');
insert into SfcClassMap values ('S88-TIMEOUT-BLOCK','com.ils.timedDelayStep','');
insert into SfcClassMap values ('S88-WRITE-FILE-TASK','com.ils.writeFileStep','');
insert into SfcClassMap values ('S88-WRITE-OUTPUTS-TASK','com.ils.writeOutputsStep','');
