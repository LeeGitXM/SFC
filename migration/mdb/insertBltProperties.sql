...
insert into BltPropertyMap values ('GDL-CONTROL-DELAY','delay','delay','DOUBLE',1,'NONE');
...
insert into BltPropertyMap values ('GDL-LINEAR-FIT','requireFullHistory','RequireFill','BOOLEAN',1,'NONE');
