...
insert into TagMap values ('AB-BALER-VOL-FTNIR-DATA','[]LabData/VFU/AB_BALER_VOL_FTNIR/value','DOUBLE');
insert into TagMap values ('AB-BALER-VOL-FTNIR-SQC-PATH','[]Connections/ABBalerVolFtnir','STRING');
insert into TagMap values ('AB-BALER-VOL-LAB-DATA','[]LabData/VFU/AB_BALER_VOL_LAB_DATA/value','DOUBLE');
...
insert into TagMap values ('FRNT_AVG_C2_TARGET','[]UnitParameter/CRx/FRNT_AVG_C2_TARGET','DOUBLE');
...
insert into TagMap values ('GAIN_AVG-C2_MAIN-C3','[]UnitParameter/CRx/AVG-C2-MAIN-C3-GAIN','DOUBLE');
insert into TagMap values ('GAIN_CAT_C3','[]UnitParameter/CRx/CAT-C3-GAIN','DOUBLE');
insert into TagMap values ('GAIN_CAT_TEMP','[]UnitParameter/CRx/CAT-TEMP-GAIN','DOUBLE');
insert into TagMap values ('GAIN_CNTR-TPR-TIP_SS-C3-to-C2','[]UnitParameter/CRx/CNTR-TPR_TIP-SS-C3-C2-GAIN','DOUBLE');
insert into TagMap values ('GAIN_FRNT-C2_MAIN-FD','[]UnitParameter/CRx/FRNT-C2-MAIN-FD-GAIN','DOUBLE');
insert into TagMap values ('GAIN_FRNT-C2_SDSTRM-FD','[]UnitParameter/CRx/FRNT-C2-SDSTRM-FD-GAIN','DOUBLE');
insert into TagMap values ('GAIN_LNGTH_TEMP','[]UnitParameter/CRx/LNGTH-TEMP-GAIN','DOUBLE');
insert into TagMap values ('GAIN_ML_TEMP','[]UnitParameter/CRx/ML-TEMP-GAIN','DOUBLE');
...
insert into TagMap values ('MAIN-C2','[]UnitParameter/CRx/MAIN-C2','DOUBLE');
insert into TagMap values ('MAIN-C3','[]UnitParameter/CRx/MAIN-C3','DOUBLE');
...
insert into TagMap values ('PREMIX_LINE_DATA_OK-GDA','[]UnitParameter/CRx/PREMIX_LINE_DATA_OK ','STRING');
insert into TagMap values ('PREMIX_LINE_FRESH-GDA-PARAMETER','[]UnitParameter/CRx/PREMIX_LINE_FRESH-PARAMETER','STRING');
...
insert into TagMap values ('SD-STRM-C2_FLOW','[]DiagnosticToolkit/CSTR/VRF202S','DOUBLE');
...
insert into TagMap values ('SERIES_RATE_CHANGE-GDA-INPUT','[]Site/POLY_RATE_CHANGE_SYSTEM/SERIES_RATE_CHANGE-INPUT','BOOLEAN');
...
insert into TagMap values ('SINGLE_FLYING_SWITCH-GDA-INPUT','[]Site/POLY_FLYING_SWITCH_SYSTEM/SINGLE_FLYING_SWITCH-INPUT','BOOLEAN');
insert into TagMap values ('SINGLE_FLYING_SWITCH_OUTPUT','[]Connections/SingleFlyingSwitchOutput','STRING');
insert into TagMap values ('SINGLE_RATE_CHANGE-GDA-INPUT','[]Site/POLY_RATE_CHANGE_SYSTEM/SINGLE_RATE_CHANGE-INPUT','BOOLEAN');
...
insert into TagMap values ('SPLIT_FLYING_SWITCH-GDA-INPUT','[]Site/POLY_FLYING_SWITCH_SYSTEM/SPLIT_FLYING_SWITCH-INPU','BOOLEAN');
insert into TagMap values ('SPLIT_FLYING_SWITCH_OUTPUT','[]Connections/SplitFlyingSwitchOutput','STRING');
insert into TagMap values ('SPLIT_RATE_CHANGE-GDA-INPUT','[]Site/POLY_RATE_CHANGE_SYSTEM/SPLIT_RATE_CHANGE-INPUT','BOOLEAN');
