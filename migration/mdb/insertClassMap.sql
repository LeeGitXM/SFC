...
insert into ClassMap values ('GDL-INFERENCE-COUNTER','com.ils.block.InferenceCounter');
...
insert into ClassMap values ('GDL-INFERENCE-INHIBIT','com.ils.block.InferenceInhibit');
